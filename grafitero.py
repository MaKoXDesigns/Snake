...
InstruccionMenu = Fuente_Texto.render('Presione SPACE para entrar a la opcion', True, VerdeObjetoClaro)
InstruccionMenu2 = Fuente_Texto.render('Presione X para volver al la menu', True, VerdeObjetoClaro)
Creditos1 = Fuente_Texto.render('Este juego fue desarrollado por', True, VerdeObjetoClaro)
Creditos2 = Fuente_Texto.render('Valentin Caligiuri, sin fines de lu-', True, VerdeObjetoClaro)
Creditos3 = Fuente_Texto.render('crar. Solo para disfrutar...', True, VerdeObjetoClaro)
...
class grafica(object):
	...
	def Titulo(self, seleccion):
		if seleccion == 0:
			pygame.draw.rect(ventana, VerdeObjetoClaro, (110,200,300,29))
		elif seleccion == 1:
			pygame.draw.rect(ventana, VerdeObjetoClaro, (110,230,300,29))
		...
		for i in secciones:
			...
			if secciones.index(i) == len(secciones)-1:
				...
				if i != Pcomida:
					...
					return ((random.randint(0,39)*20, random.randint(0,29)*20),puntuacion)
				break
	...
	def Score(self, puntuacion):
		...
		Puntos = Fuente_Texto.render(str(puntuacion), True, VerdeObjeto)
